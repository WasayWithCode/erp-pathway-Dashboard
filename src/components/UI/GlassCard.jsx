const GlassCard = ({ children, className = "", as: Component = "div", onPointerMove, ...props }) => {
  ...
  return (
    <Component
      className={`premium-card-surface relative overflow-hidden rounded-[1.35rem] border border-white/85 bg-white/82 backdrop-blur-2xl transition duration-300 hover:border-blue-200 ${className}`}
